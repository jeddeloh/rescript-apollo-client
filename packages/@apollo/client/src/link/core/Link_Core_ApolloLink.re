...
module GraphQLRequest = Link_Core_Types.GraphQLRequest;
module Observable = ZenObservable.Observable;
module Operation = Link_Core_Types.Operation;
module RequestHandler = Link_Core_Types.RequestHandler;
...
module Js_ = {
  ...
  module Static = {
    ...
    [@bs.module "@apollo/client"] [@bs.scope "ApolloLink"]
    external split:
      (~test: Operation.Js_.t => bool, ~whenTrue: t, ~whenFalse: t) => t =
      "split";
    // static execute(link: ApolloLink, operation: GraphQLRequest): Observable<FetchResult>;
    [@bs.module "@apollo/client"] [@bs.scope "ApolloLink"]
    external execute:
  ...
  [@bs.send]
  external split:
    (t, ~test: Operation.Js_.t => bool, ~whenTrue: t, ~whenFalse: t) => t =
    "split";
};
