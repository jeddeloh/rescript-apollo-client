module FieldNode = Graphql.Language.Ast.FieldNode;
module FragmentMap = Utilities_Graphql_Fragments.FragmentMap;
...
module Resolver = {
  module Js_ = {
    type t_context = {
      client: apolloClient,
      cache: Cache_Core_Cache.ApolloCache.t(Js.Json.t),
    };
