...
function Home() {
  ...
  return (
    ...
    >
      <header className={clsx('hero hero--primary white-bg', styles.heroBanner)}>
          ...
          <div className={styles.index}>
            ...
            <span className={styles.indexGitHubButtonWrapper}>
              <iframe
                ...
                src="https://ghbtns.com/github-btn.html?user=reasonml-community&amp;repo=reason-apollo-client&amp;type=star&amp;count=true&amp;size=large"
                width={160}
                height={30}
                title="GitHub Stars"
              />
