module KeyFieldsFunction = Cache_InMemory_Policies.KeyFieldsFunction;
module PossibleTypesMap = Cache_InMemory_Policies.PossibleTypesMap;
module TypePolicies = Cache_InMemory_Policies.TypePolicies;
...
module Js_ = {
  ...
  // }
  type t = Cache_Core_Cache.ApolloCache.Js_.t(Js.Json.t);
