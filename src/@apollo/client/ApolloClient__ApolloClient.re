...
type t = {
  ...
  clearStore:
    unit => Js.Promise.t(Belt.Result.t(array(Js.Json.t), Js.Exn.t)),
  [@bs.as "reason_mutate"]
  mutate:
...
let make:
  ...
  (
    ...
    let clearStore = () =>
      ...
      ->Js.Promise.catch(
          e => Js.Promise.resolve(Error(Utils.ensureError(Any(e)))),
          _,
        );
    ...
    let resetStore:
      ...
      () =>
        ...
        ->Js_.resetStore
        ->Js.Promise.then_(
            value => Js.Promise.resolve(Ok(value->Js.toOption)),
            _,
          )
        ->Js.Promise.catch(
            e => Js.Promise.resolve(Error(Utils.ensureError(Any(e)))),
